...
<nav class="navbar navbar-default navbar-static-top" role="navigation"
    ...
    <div style="float: right;margin:10px 80px 0 0;"><span>欢迎<%=s%>,&nbsp;<%=emp.getEmp_name()%>&nbsp;</span><img src="<%=basePath%>imgs/tuichu.png" alt="" onclick="tuichu()" style="cursor: pointer;height: 25px; width: 25px;"></div>
    <script>
        function tuichu() {
