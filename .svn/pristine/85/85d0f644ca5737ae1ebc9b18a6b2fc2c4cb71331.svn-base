...
<div class="navbar-default sidebar" role="navigation" style="margin-top: 0px;">
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
            ...
            <li>
                <a href="${pageContext.request.contextPath }/super/supadmin" >
                    <span class="glyphicon glyphicon-pencil" aria-hidden="true" style="padding: 3px 0 3px 0;"></span> 权限管理
                </a>
            </li>
            <li>
                <a href="${pageContext.request.contextPath }/super/getadmsg">
                    <span class="glyphicon glyphicon-edit" aria-hidden="true" style="padding: 3px 0 3px 0;"></span> 管理员信息
                </a>
            </li>
            <li>
                <a href="${pageContext.request.contextPath }/super/supAdInfo">
